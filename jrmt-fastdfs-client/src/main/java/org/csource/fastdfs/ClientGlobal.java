...
*/
	...
	public static void init(DFSConfig config) throws FileNotFoundException, IOException, MyException
	{
  		String[] szTrackerServers;
			String[] parts;
  		...
  		//此处的tracker_server可以预制多个
  		szTrackerServers = config.getTracker_servers();
  		...
  		g_anti_steal_token = config.getHttp_anti_steal_token();
  		if (g_anti_steal_token)
  		{
